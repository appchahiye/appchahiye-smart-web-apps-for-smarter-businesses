  ...
  theme: {
  	extend: {
  		...
  		boxShadow: {
            ...
            'soft-glow': '0 0 25px -5px rgba(91, 46, 255, 0.2)',
  		},
  		keyframes: {
  			'fade-in': {
  				'0%': {
  		...
  		backgroundImage: {
            ...
            'gradient-soft-light': 'radial-gradient(circle at top left, #F7F3FF 0%, #FFFFFF 50%)',
            'gradient-soft-dark': 'radial-gradient(circle at top left, #1a1a2e 0%, #161625 50%)',
  		}
  	}
  },
